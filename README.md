...
```bash
# Copy built files to example
cp dist/index.js example/lib/index.cjs
cp dist/index.mjs example/lib/index.js
cp dist/index.d.ts example/lib/index.d.ts
cp dist/index.d.mts example/lib/index.d.cts
...
1. Edit files in `src/`
2. Run `npx tsup` to rebuild
3. Copy dist files to `example/lib/`
