        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
          <tbody>
            <tr>
              ...
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)', color: 'rgba(0,0,0,0.5)', textAlign: 'right' }}>Toggle feedback mode</td>
            </tr>
            <tr>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)' }}><code>Esc</code></td>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)', color: 'rgba(0,0,0,0.5)', textAlign: 'right' }}>Close toolbar or cancel</td>
            </tr>
            <tr>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)' }}><code>P</code></td>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)', color: 'rgba(0,0,0,0.5)', textAlign: 'right' }}>Pause/resume animations</td>
            </tr>
            <tr>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)' }}><code>H</code></td>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)', color: 'rgba(0,0,0,0.5)', textAlign: 'right' }}>Hide/show markers</td>
            </tr>
            <tr>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)' }}><code>C</code></td>
              <td style={{ padding: '0.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.1)', color: 'rgba(0,0,0,0.5)', textAlign: 'right' }}>Copy feedback</td>
            </tr>
            <tr>
