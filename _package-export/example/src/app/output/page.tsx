...
const FORMAT_SCALES: Record<OutputFormat, number> = {
  compact: 1,
  standard: 1.06,
  detailed: 1.12,
  forensic: 1.25,
...
function ModeIndicatorBunny({ format }: { format: OutputFormat }) {
  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes forensicLeftEarPerk {
          0% { transform: rotate(0deg) translateY(0); }
          15% { transform: rotate(-25deg) translateY(-2px); }
          100% { transform: rotate(0deg) translateY(0); }
        }
        @keyframes forensicRightEarPerk {
          0% { transform: rotate(0deg) translateY(0); }
          15% { transform: rotate(25deg) translateY(-2px); }
          100% { transform: rotate(0deg) translateY(0); }
        }
        @keyframes modeLeftEyeMove {
