  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Yes. The toolbar has a pause button that freezes CSS animations and transitions. Note that JavaScript-driven animations (like Framer Motion, React Spring, or GSAP) won't be affected."
      },
      {
        question: "Can I customize marker colors?",
        answer: "Yes. Open the settings panel (gear icon) to choose from preset colors for annotation markers. Your preference is saved in <code>localStorage</code>."
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "You can, but it's designed as a development tool. Most teams conditionally render it only in development or behind a feature flag. The toolbar is invisible to users until activated."
      },
      {
    ...
    items: [
      {
        ...
        answer: "Drop us a note on X. Reach out to <a href=\"https://x.com/benjitaylor\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"faq-link\">Benji</a> or <a href=\"https://x.com/seldom\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"faq-link\">Dennis</a>. We appreciate all feedback."
      },
    ]
  },
];
