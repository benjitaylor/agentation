...
export default function NotFound() {
  return (
    <div style={{
      ...
      <AnimatedBunnyGrey />
      <p style={{ color: 'rgba(0,0,0,0.4)', fontSize: '0.875rem' }}>Page not found.</p>
    </div>
  );
}
